...
<template>
    <div id="universe">
      ...
      <div id="tablette">
        ...
        <div class="star" style="transform: rotateZ(68deg); animation-duration: 1.481s; animation-delay: 2.588s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(112deg); animation-duration: 2.616s; animation-delay: 0.35s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(354deg); animation-duration: 1.031s; animation-delay: 1.646s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(240deg); animation-duration: 1.459s; animation-delay: 1.319s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(255deg); animation-duration: 2.481s; animation-delay: 2.374s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(239deg); animation-duration: 2.115s; animation-delay: 0.811s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(113deg); animation-duration: 1.931s; animation-delay: 2.667s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(30deg); animation-duration: 2.828s; animation-delay: 0.361s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(310deg); animation-duration: 1.238s; animation-delay: 2.157s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(52deg); animation-duration: 2.882s; animation-delay: 2.186s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(108deg); animation-duration: 1.852s; animation-delay: 2.7s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(355deg); animation-duration: 2.555s; animation-delay: 1.06s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(281deg); animation-duration: 1.811s; animation-delay: 1.483s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(52deg); animation-duration: 2.936s; animation-delay: 1.981s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(235deg); animation-duration: 2.061s; animation-delay: 2.297s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(225deg); animation-duration: 1.87s; animation-delay: 1.766s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(235deg); animation-duration: 2.056s; animation-delay: 2.341s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(155deg); animation-duration: 1.211s; animation-delay: 0.463s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(101deg); animation-duration: 2.797s; animation-delay: 1.209s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(15deg); animation-duration: 2.263s; animation-delay: 1.865s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(332deg); animation-duration: 2.173s; animation-delay: 0.301s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(223deg); animation-duration: 1.939s; animation-delay: 0.054s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(127deg); animation-duration: 1.113s; animation-delay: 1.733s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(250deg); animation-duration: 1.002s; animation-delay: 2.02s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(182deg); animation-duration: 1.705s; animation-delay: 0.686s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(14deg); animation-duration: 1.116s; animation-delay: 1.346s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(124deg); animation-duration: 2.509s; animation-delay: 1.01s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(64deg); animation-duration: 2.47s; animation-delay: 2.323s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(83deg); animation-duration: 1.902s; animation-delay: 1.519s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(17deg); animation-duration: 1.744s; animation-delay: 1.661s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(227deg); animation-duration: 1.77s; animation-delay: 1.834s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(152deg); animation-duration: 2.476s; animation-delay: 1.986s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(57deg); animation-duration: 1.414s; animation-delay: 0.558s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(144deg); animation-duration: 1.516s; animation-delay: 0.554s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(183deg); animation-duration: 1.487s; animation-delay: 0.975s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(47deg); animation-duration: 1.755s; animation-delay: 2.756s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(27deg); animation-duration: 2.228s; animation-delay: 1.19s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(280deg); animation-duration: 1.665s; animation-delay: 0.166s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(70deg); animation-duration: 1.657s; animation-delay: 2.584s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(331deg); animation-duration: 1.818s; animation-delay: 1.677s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(304deg); animation-duration: 1.801s; animation-delay: 2.453s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(18deg); animation-duration: 2.628s; animation-delay: 1.826s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(259deg); animation-duration: 2.827s; animation-delay: 0.666s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(309deg); animation-duration: 1.361s; animation-delay: 2.394s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(297deg); animation-duration: 2.324s; animation-delay: 1.989s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(143deg); animation-duration: 1.237s; animation-delay: 1.824s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(59deg); animation-duration: 2.21s; animation-delay: 2.196s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(327deg); animation-duration: 2.413s; animation-delay: 0.615s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(34deg); animation-duration: 1.047s; animation-delay: 0.192s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(294deg); animation-duration: 1.121s; animation-delay: 2.746s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(115deg); animation-duration: 1.21s; animation-delay: 1.876s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(351deg); animation-duration: 2.402s; animation-delay: 2.925s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(258deg); animation-duration: 2.614s; animation-delay: 1.341s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(76deg); animation-duration: 2.991s; animation-delay: 1.29s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(26deg); animation-duration: 1.794s; animation-delay: 1.083s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(356deg); animation-duration: 1.34s; animation-delay: 1.572s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(246deg); animation-duration: 1.332s; animation-delay: 2.992s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(207deg); animation-duration: 2.516s; animation-delay: 1.954s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(232deg); animation-duration: 2.15s; animation-delay: 0.034s;"><div class="point"></div></div>
        <div class="star" style="transform: rotateZ(304deg); animation-duration: 2.317s; animation-delay: 0.419s;"><div class="point"></div></div>
